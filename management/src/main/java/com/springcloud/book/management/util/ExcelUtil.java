...
import com.springcloud.book.management.enums.ExcelType;
...
public class ExcelUtil<T> {
     ...
     * @throws Exception
     */
    public void export(String excelTypeStr , List<T> list, HttpServletResponse response,String fileName)throws Exception{
