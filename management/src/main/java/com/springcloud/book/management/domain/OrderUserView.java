 ...
 * @since 2019-09-24
 */
@TableName("fd_order_user_view")
public class OrderUserView extends Model<OrderUserView> {
     ...
     * ella中用户的id
     */
    @TableField("user_ella_id")
    private String userEllaId;
    ...
    public String getUserEllaId() {
        return userEllaId;
    }

    public void setUserEllaId(String userEllaId) {
        this.userEllaId = userEllaId;
    }
