...
import com.springcloud.book.foreign.util.infoProcessor.processor.impl.deal.ImplDeal;
 ...
 *
 * @author Ryan
 * 该类实现了Processor接口,专门处理NoteExpress格式的文献信息
 *
 */
public class NoteExpressProcessor implements Processor {

	@Override
	public List<DocInfoVO> proccessSolr(List<AbstractSolr> abstractList) {
		List<DocInfoVO> docInfoList = new ArrayList<>();
		LabelVO label = LabelFactory.getNoteExpressLabel();
