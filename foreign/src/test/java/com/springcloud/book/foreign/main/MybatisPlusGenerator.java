package com.springcloud.book.foreign.main;
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new StrategyConfig()
                        ...
                        .setNaming(NamingStrategy.underline_to_camel)// 表名生成策略
                         .setInclude(new String[] {"fd_abstract_volums_count_for_journal"}) // 需要生成的表
                ...
                // 包配置
                new PackageConfig()
                        .setParent("com.springcloud.book.foreign")// 自定义包路径
                        .setEntity("domain")
